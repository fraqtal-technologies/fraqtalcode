export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Fraqtal wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Fraqtal CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
