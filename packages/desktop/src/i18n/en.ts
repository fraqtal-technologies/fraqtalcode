export const dict = {
  ...
  "desktop.menu.help.documentation": "Fraqtal Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Fraqtal has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Fraqtal CLI binary is missing. Try reinstalling the desktop app.",
