export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Fraqtal",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Fraqtal، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Fraqtal",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Fraqtal CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
