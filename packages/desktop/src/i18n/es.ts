export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Fraqtal. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Fraqtal",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Fraqtal. Intenta reinstalar la aplicación de escritorio.",
