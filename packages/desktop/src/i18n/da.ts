export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Fraqtal er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "Fraqtal Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Fraqtal CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
