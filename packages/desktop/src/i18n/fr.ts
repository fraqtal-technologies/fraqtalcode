export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de Fraqtal a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation Fraqtal",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Fraqtal est manquant. Essayez de réinstaller l'application de bureau.",
