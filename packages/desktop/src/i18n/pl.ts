export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Fraqtal. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Fraqtal",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Fraqtal CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
