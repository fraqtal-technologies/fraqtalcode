export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Fraqtal foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Fraqtal",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Fraqtal está ausente. Tente reinstalar o aplicativo de desktop.",
