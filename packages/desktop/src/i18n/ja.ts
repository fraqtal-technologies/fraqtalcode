export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Fraqtal を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Fraqtal のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "Fraqtal ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Fraqtal CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
