export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Fraqtal",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Fraqtal er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Fraqtal Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Fraqtal CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
